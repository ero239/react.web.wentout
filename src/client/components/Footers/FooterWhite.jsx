...
export default class FooterBlack extends PureComponent {
  render() {
    return (
      <footer className={styles.footer} style={{backgroundColor: 'white', color: 'black'}} id="footer">
        ...
        <nav className={styles.footerLinksFlex}>
          <ul className={styles.footerLinks}>
            <Link to="/about/terms" className={styles.footerLink} style={{color: 'black'}}>
              Terms of use
            </Link>
          </ul>
          <ul className={styles.footerLinks}>
            <Link to="/about/privacy" className={styles.footerLink} style={{color: 'black'}}>
              Privacy & Policy
            </Link>
          </ul>
          <ul className={styles.footerLinks}>
            <Link to="/about/us" className={styles.footerLink} style={{color: 'black'}}>
              About us
            </Link>
          </ul>
        </nav>
        ...
        <div className={styles.footerSocialLinksFlex}>
          <div className={styles.footerSocialLinksContainer}>
            <ul className={styles.footerSocialLinksList} style={{color: 'black'}}>
              ...
              <li className={styles.footerSocialLinksObject}>
                ...
                >
                  <i className="fa fa-google-plus" style={{color: 'black'}} />
                </a>
              </li>
              <li className={styles.footerSocialLinksObject}>
                <a
              ...
              <li className={styles.footerSocialLinksObject}>
                ...
                >
                  <i className="fa fa-instagram" style={{color: 'black'}} />
                </a>
              </li>
            </ul>
          </div>
